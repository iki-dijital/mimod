...
<section id="page-banner" class="bg-primary mb-7.5 md:mb-0">
    <div class="container h-full flex flex-col justify-center">
        ...
        <nav id="banner-breadcrumb" class="flex justify-center items-center gap-x-6 flex-wrap gap-y-2"" aria-label="Sayfa haritası">
            ...
            <a href="" class="text-light leading-tight relative transition-colors transition-300 whitespace-nowrap sm:text-sm">Haber Başlık</a>
        </nav>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="content-wrapper">
                    <div class="visit_date text-secondary leading-relaxed mb-6">29 Kasım 2023</div>
                    <img src="<?= domain ?>assets/img/haber_img.webp" alt="Haber Görseli" class="block w-full mb-6">
                    <h2>Haber Başlığı</h2>
                    <p>
                    ...
                    <div class="flex justify-center w-full mt-23 md:mt-8">
                        <a href=""

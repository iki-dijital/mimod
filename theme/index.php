...
?>
<main>
    <section id="home-banner" class="relative z-1 mb-19 sm:mb-10">
        <div class="fade-slide-container relative before-absolute" id="banner-fade">
            <div class="slide-wrapper relative z-1">
                <?php for ($i = 1; $i <= 4; $i++): ?>
                    <div class="slide-item <?= $i == 1 ? 'active ' : '' ?>">
                        <div class="relative">
                            <div class="bg bg-primary absolute top-0 left-0 w-full h-9/10 md:h-full"></div>
                            <div class="container pt-2 relative z-2">
                                <div class="row">
                                    <div class="col-xl-5 col-lg-6 md:order-2">
                                        <div class="content flex flex-col justify-center items-start h-full pb-3.5 gap-y-9 xl:justify-start xl:pt-15 md:pt-8 xl:gap-y-5">
                                            <h2
                                                class="text-secondary text-3xl lg:text-xl font-bold leading-snug my-0 opacity-0 transition-500">
                                                <?= $i ?> OTOPARK YÖNETMELİĞİNDE DEĞİŞİKLİK YAPILMASINA DAİR YÖNETMELİK
                                            </h2>
                                            <p class="text-white text-xl lg:text-base leading-snug opacity-0 transition-500 my-0">
                                    ...
                                    <div class="col-xl-7 col-lg-6 md:order-1">
            ...
            <div class="slide-nav flex items-end">
                <div class="container pb-4.5 flex gap-x-2.5 items-center md:justify-end">
                    <div class="prev">
    ...
    <section id="home-quicklinks" class="mb-20 sm:mb-10">
        <div class="container">
            <div class="row md:gap-y-6">
                <div class="col-lg-4">
                    <a href=""
    ...
    <section id="home-organisations" class="mb-22.5">
        <div class="container">
            <div class="row md:gap-y-6">
                <div class="col-lg-4">
                    <div class="org_link relative before-absolute pt-5.5 px-6.5 xl:px-4 md:px-10 xs:px-5">
                        ...
                        <div class="black_box relative before-absolute pb-25 pt-9 px-5 lg:px-2 md:px-10 xs:px-5 rounded-sm bg-secondary">
                            <p class="my-0 text-white leading-snug lg:text-sm text-center relative z-1">Aradığınız kitapları
                                Mimarlar Odası Konya Şubesi kütüphanesi data bankasından sorgulayabilirsiniz.</p>
                            <a href=""
                                class="btn absolute bottom-5 bg-primary text-white text-center px-11.5 lg:px-5 left-1/2 z-1">İncele</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
    ...
    <section id="home-papers" class="relative before-absolute">
        <div class="container relative z-1">
            <div class="row">
                        ...
                        <div class="blaze-container">
                            <div class="blaze-track-container">
                                <div class="blaze-track">
                                    <?php for ($i = 1; $i <= 10; $i++): ?>
                                        <div>
                                            <a href="" class="mimaran_cover block p-4 lg:px-2 bg-white transition-300 transition-shadow">
                                                <div class="img border border-solid border-dark pt-4 pb-5 px-12 lg:px-7 flex flex-col justify-end">
                ...
                <div class="col-lg-12 flex justify-between items-center mb-20 xl:mb-10">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 relative z-2">
                    <img src="<?= domain ?>assets/img/kutuphane.webp" alt="Kütüphane"
                        class="absolute bottom-0 w-full md:w-3/5 sm:w-6/12 object-contain object-center">
                </div>
                <div class="col-lg-3 flex items-end">
                    <div
                        class="library-title relative before-absolute after-absolute pt-12 pb-14 xs:px-5 xs:py-8 text-white text-right md:text-left flex flex-col gap-y-5.5 justify-center bg-primary">
                        <h2 class="text-3xl xs:text-xl my-0 font-bold leading-snug relative z-1">MİMARLAR ODASI KONYA ŞUBE
                            KÜTÜPHANESİ</h2>
    ...
    <section id="in-network-provider">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="wrapper relative before-absolute after-absolute bg-cream">
                        <div class="row relative z-1">
                            <div class="col-lg-10 offset-lg-1">
                                <div class="row">
                                    <div class="col-xl-5 col-lg-8 py-15 md:px-6 sm:py-5 flex flex-col items-start md:items-center gap-y-6">
                                        <h2 class="text-secondary text-3xl font-bold leading-snug my-0 ">ANLAŞMALI
                                            KURUMLAR
                                        </h2>
                                        <p class="text-white md:text-center leading-snug my-0">
                        ...
                        <img src="<?= domain ?>assets/img/network_img.webp" alt="Anlaşmalar" loading="lazy"
                            class="block md:hidden absolute top-0 right-0 w-1/2 h-full z-1 object-cover object-left">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <ul class="nav nav-tabs bg-primary md:flex sm:flex-wrap" id="home-career-tabs" role="tablist">
                        ...
                        for ($i = 1; $i <= 4; $i++): ?>
                         <li class="nav-item md:flex-1 sm:flex-none sm:w-1/2" role="presentation">
                                <button class="nav-link py-5 px-10 md:px-3 md:w-full text-white cursor-pointer transition-colors transition-300 <?= $i == 1 ? 'active' : '' ?>" id="tab-<?= $i ?>"
                    ...
                    <div class="tab-content relative before-absolute py-5" id="home-careers-tab-content">
                        <?php for ($i = 1; $i <= 4; $i++): ?>
                            <div class="tab-pane <?= $i == 1 ? 'show active' : '' ?>" id="tab-<?= $i ?>-content"
                                ...
                                <?php for ($j = 1; $j <= 10; $j++): ?>
                                    <div class="<?=$j % 2 == 0 ? 'sm:pl-1.5' : 'sm:pr-1.5'?> xs:px-0 sm:w-1/2 xs:w-full">
                                    <div class="p-2 bg-white mb-6 sm:mb-3 px-3">
                                        <div class="row sm:gap-y-3 sm:py-3">
                                            ...
                                            <div class="col-md-3 flex flex-col justify-center sm:items-center">
                                            ...
                                            <div class="col-md-3 offset-lg-1 flex flex-col justify-center sm:items-center">
                                            ...
                                            <div class="col-lg-2 col-md-3 offset-lg-1 flex items-center justify-center">
                                                <a href=""
    ...
    <section id="home-social">
        <div class="container">
            <div class="wrapper">
                <span class="text-3xl xs:text-lg text-dark leading-none text-center mb-7.5 block">@MimodKonya <strong class="font-bold">BİZİ TAKİP EDİN</strong></span>
                <div class="flex justify-center gap-x-6 xs:gap-6 xs:flex-wrap">
                    <a href="" class="aspect-square flex flex-col justify-center items-center xs:flex-none gap-y-8 p-5 bg-white rounded-sm transition-300 transition-colors">

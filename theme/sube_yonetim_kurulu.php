...
<section id="page-banner" class="bg-primary mb-7.5 md:mb-0">
    <div class="container h-full flex flex-col justify-center">
        ...
        <nav id="banner-breadcrumb" class="flex justify-center items-center gap-x-6 flex-wrap gap-y-2"" aria-label="Sayfa haritası">
            ...
            <a href="" class="text-light leading-tight relative transition-colors transition-300 whitespace-nowrap sm:text-sm">Hakkımızda</a>
            <a href="" class="text-light leading-tight relative transition-colors transition-300 whitespace-nowrap sm:text-sm">Şube Yönetim
                Kurulu</a>
        </nav>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-xl-9 col-lg-8">
                <div class="content-wrapper">
                    ...
                    <div
                        class="open-accordion-title bg-primary text-light font-semibold min-h-15 py-3 flex items-center px-5 text-xl leading-normal">
                        18. Dönem Yönetim Kurulu</div>
                    <div class="open-accordion-content pt-6 pb-7.5">
                        <div class="row">
                            <?php for ($i = 1; $i <= 13; $i++): ?>
                                <div class="col-sm-3 col-6 <?= $i == 1 ? 'first-member' : '' ?>">
                            ...
                            <div class="accordion-item mb-3">
                                ...
                                <div id="collapse-<?= $i ?>"
                                    ...
                                    <div class="accordion-body">
                                        <div class="row">
                                            <?php for ($j = 1; $j <= 13; $j++): ?>
                                                <div class="col-sm-3 col-6 <?= $j == 1 ? 'first-member' : '' ?>">
                                                    <div class="board-member mb-7.5">
                                                        <div class="img mb-3">
                                                            <img src="<?= domain ?>assets/img/svg/member_<?= rand(1, 2) % 2 == 0 ? 'male' : 'female' ?>.svg"
                                                                alt="Üye görseli"

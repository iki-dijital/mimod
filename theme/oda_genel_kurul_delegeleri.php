...
<section id="page-banner" class="bg-primary mb-7.5 md:mb-0">
    <div class="container h-full flex flex-col justify-center">
        ...
        <nav id="banner-breadcrumb" class="flex justify-center items-center gap-x-6 flex-wrap gap-y-2"" aria-label="Sayfa haritası">
            ...
            <a href="" class="text-light leading-tight relative transition-colors transition-300 whitespace-nowrap sm:text-sm">Oda Genel Kurul
                Delegeleri</a>
        </nav>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-xl-9 col-lg-8">
                <div class="content-wrapper">
                    <h2>Oda Genel Kurul Delegeleri</h2>
                    <div class="delegates-table flex xs:flex-wrap gap-x-7">
                        <div class="flex-1 xs:flex-none xs:w-full">
                            <div

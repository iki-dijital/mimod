...
<section id="page-banner" class="bg-primary mb-7.5 md:mb-0">
    <div class="container h-full flex flex-col justify-center">
        ...
        <nav id="banner-breadcrumb" class="flex justify-center items-center gap-x-6 flex-wrap gap-y-2"" aria-label="Sayfa haritası">
            ...
            <a href="" class="text-light leading-tight relative transition-colors transition-300 whitespace-nowrap sm:text-sm">Mimaran</a>
        </nav>
    </div>
</section>
                    ...
                    <div class="row">
                        <?php for ($i = 1; $i <= 10; $i++): ?>
                            <div class="col-md-4 col-6">
                                <a href="" class="mimaran_cover block p-4 lg:px-2 bg-white mb-10 transition-shadow transition-300">

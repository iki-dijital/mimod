...
<section id="page-banner" class="bg-primary mb-7.5">
    <div class="container h-full flex flex-col justify-center">
        ...
        <nav id="banner-breadcrumb" class="flex justify-center items-center gap-x-6" aria-label="Sayfa haritası">
            ...
            <a href="" class="text-light leading-tight relative transition-colors transition-300">Etkinlik Adı</a>
        </nav>
    </div>
</section>
            ...
            <div class="col-lg-6">
                <div class="content-wrapper h-full flex flex-col">
                    ...
                    <div class="flex flex-col flex-1">
                        <div class="event-details flex flex-col gap-y-4 mt-17">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <a href="https://www.youtube.com/watch?v=DQmFFcAeD7E"
                                class="glightbox bg-secondary relative">
                                <div

...
<section id="page-banner" class="bg-primary mb-7.5 md:mb-0">
    <div class="container h-full flex flex-col justify-center">
        ...
        <nav id="banner-breadcrumb" class="flex justify-center items-center gap-x-6 flex-wrap gap-y-2"" aria-label="Sayfa haritası">
            ...
            <a href="" class="text-light leading-tight relative transition-colors transition-300 whitespace-nowrap sm:text-sm">Öğrenci Üyelik</a>
        </nav>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-xl-9 col-lg-8">
                <div class="content-wrapper">
                    ...
                    <?php endfor; ?>
                    <div class="text-center pt-10 xs:pt-2">
                        <a
                            href="" class="register-form-button bg-primary inline-flex items-center min-h-15 px-8 py-4 text-light font-semibold transition-300 transition-colors">Başvuru
                            Formu İçin Tıklayınız</a>
                    </div>
                </div>
            </div>
